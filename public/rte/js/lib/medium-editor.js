...
buttonTemplate: function (btnType) {
    ...
    buttonTemplates = {
        ...
        'math': '<button class="medium-editor-action medium-editor-action-anchor" data-action="append-h4" data-element="h4">' + buttonLabels.math + '</button>',
